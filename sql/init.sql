...
); -- the content of the specific dialogue between the user and an agency
...
); -- agency's all classes 

create table if not exists `test_class_table` ( -- only test table, standard format: [class_id]_class_table
  `class_id` varchar(19) not null,
